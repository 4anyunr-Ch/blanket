...
- (void)initSubviews
{
    ...
    [cancelButton setBackgroundImage:[UIImage imageNamed:@"STPhotoKit.bundle/STPhotoKitNav_back"] forState:UIControlStateNormal];
    cancelButton.centerY = 20 + 22;
    ...
    self.titleButton.centerY = 20 + 22;
    ...
    //更多按钮
    self.rightButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-30-10, 0, 25, 25)];
    self.rightButton.titleLabel.font = [UIFont systemFontOfSize:15];
    [self.rightButton setTitle:@"" forState:UIControlStateNormal];
    self.rightButton.centerY = 20 + 22;
    self.rightButton.backgroundColor = [UIColor clearColor];
    self.rightButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    UIImage * normalImage =  [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"STPhotoKit.bundle/btn_more@2x"] ofType:@"png"]];
    UIImage * selectedImage =  [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"STPhotoKit.bundle/btn_more@2x"] ofType:@"png"]];
    [self.rightButton setBackgroundImage:normalImage forState:UIControlStateNormal];
    [self.rightButton setBackgroundImage:selectedImage forState:UIControlStateSelected];
...
- (void)bottomAndTopViewAnimation{
    ...
    [UIView animateWithDuration:0.4 animations:^{
        ...
        if (!_shouldHideBottomView) {
             self.bootView.bottom = SCREEN_HEIGHT;
        }

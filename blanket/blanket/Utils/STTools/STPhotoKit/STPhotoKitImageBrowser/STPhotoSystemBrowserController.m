...
- (void)initSubviews
{
    ...
    UIImage * normalImage =  [UIImage imageNamed:@"img_nochoose.png"];
    UIImage * selectedImage =  [UIImage imageNamed:@"img_choose.png"];
...
- (void)initBottomView
{
    ...
    //    [self.originButton setImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
    //    [self.originButton setImage:[UIImage imageNamed:@""] forState:UIControlStateSelected];
